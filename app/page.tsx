        ...
        <main>
            <div className="h-screen w-screen rounded-md absolute bg-neutral-950 flex flex-col items-center justify-center antialiased">
                <div className="flex flex-row flex-wrap w-3/4 2xl:w-2/3">
                    <div className="flex flex-col w-full 2xl:w-3/4 min-[1920]:w-2/3 p-5">
                        ...
                        <h1 className="text-[4rem] md:text-[5rem] lg:text-[7rem] xl:text-[8rem] 2xl:text-[9rem] min-[1920]:text-[10rem] font-bold bg-gradient-to-r from-purple-300 to-purple-200 bg-clip-text text-transparent">
                            Jayden Q
                        </h1>
                    ...
                    <div className="flex w-full 2xl:w-1/4 min-[1920]:w-1/3 border-l-2 border-purple-800">
